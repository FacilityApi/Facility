...
var docsAssemblies = new[] { "_" };
var docsAssemblyDirectory = $"src/fsdgen_/bin/{configuration}";
var docsSourceUri = "https://github.com/FacilityApi/RepoName/tree/master/src";
var codeGenExe = $"src/fsdgen_/bin/{configuration}/fsdgen_.exe";

...
namespace Facility.Definition
{
	...
	public sealed class ServiceDtoInfo : IServiceMemberInfo
	{
		...
		/// Creates a DTO.
		/// </summary>
		public ServiceDtoInfo(string name, IEnumerable<ServiceFieldInfo> fields = null, IEnumerable<ServiceAttributeInfo> attributes = null, string summary = null, IEnumerable<string> remarks = null, ServiceTextPosition position = null)
		{
			if (name == null)
